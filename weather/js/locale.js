...
function setLocale() {
    ...
    if (language_chooser.value == "RU") {
        ...
        document.querySelector("#location-input").setAttribute("placeholder", "Введите город");
    } else {
        ...
        document.querySelector("#location-input").setAttribute("placeholder", "Search city");
    }
